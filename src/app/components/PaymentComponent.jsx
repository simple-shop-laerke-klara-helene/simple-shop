        ...
        <div className="grid grid-cols-[auto_1fr] border-b pb-2 bg-gray-200 rounded-lg my-4">
            ...
            <div className="flex items-center gap-2 justify-between">
                ...
                <a 
                    ...
                    className=" cursor-pointer bg-gray-200 shadow-lg rounded-lg px-3 py-2 hover:bg-gray-400"
                >
                    Remove
                 </a >
            </div>
...
<div className="bg-gray-200 rounded-lg p-6 w-70 h-90 my-4 flex flex-col gap-5 sticky top-0">
  ...
  <a className="shadow-lg rounded-lg hover:bg-gray-300 bg-white px-4 py-3 mt-auto">
    Go to payment
  </a>
</div>
    </div>
